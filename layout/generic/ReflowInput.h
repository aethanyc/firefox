...
struct ReflowInput : public SizeComputationInput {
 ...
 protected:
  ...
  GetHypotheticalBoxContainingBlock(const nsIFrame* aFrame) const;
  ...
  // absolute containing block (aAbsCBReflowInput->mFrame). The writing mode of
  ...
  void CalculateHypotheticalPosition(
      ...
      const ReflowInput* aAbsCBReflowInput, const LogicalSize& aAbsCBSize,
