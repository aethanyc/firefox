...
class nsLineBox final : public nsLineLink {
 ...
 public:
  ...
  //
  // Note: use the iterator only when the child frames in this line are not
  // mutated. If mutation is required, use mFirstChild and GetChildCount()
  // instead.
  ...
  //
  // Note: use the range-based for loop only when the child frames in this line
  // are not mutated. If mutation is required, use mFirstChild and
