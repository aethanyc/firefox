...
class AbsoluteContainingBlock {
 ...
 protected:
  ...
  // Stores the abspos frames that has been placed in this containing block.
  nsFrameList mAbsoluteFrames;

  // A temporary frame list used during reflow, storing abspos frames that needs
  // to be reflowed by the delegating frame's next-in-flow.
