...
class nsInlineFrame : public nsContainerFrame {
 ...
 protected:
  ...
  // InlineReflowInput::mSetParentPointer.
  enum class SetParentPointer : bool { No, Yes };
  ...
  struct InlineReflowInput {
    ...
    SetParentPointer mSetParentPointer = SetParentPointer::No;

    InlineReflowInput(const ReflowInput& aReflowInput,
                      SetParentPointer aSetParentPointer);
  };
